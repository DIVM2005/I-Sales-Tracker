import pandas as pd #it is for creating dataframes.
import streamlit as st #it creates an application in the shortest time.
import firebase_admin # it is to import the 
...
if not firebase_admin._apps:
    cred = credentials.Certificate("C:\\Users\\divdm\\OneDrive\\Desktop\\Certificates\\sales-tracker.json")
